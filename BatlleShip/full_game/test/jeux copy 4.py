...
class Grille:
    def __init__(self, decalage_x, decalage_y):
        ...
        self.images_navires = {
            "porte_avions": pygame.image.load("/media/nathan/liaison/Documents/Examen_POO/BatlleShip/assets/images/porte_avions.png"),
            "croiseur": pygame.image.load("/media/nathan/liaison/Documents/Examen_POO/BatlleShip/assets/images/croiseur.png"),
            "contre_torpilleur": pygame.image.load("/media/nathan/liaison/Documents/Examen_POO/BatlleShip/assets/images/contre_torpilleur.png"),
            "sous_marin": pygame.image.load("/media/nathan/liaison/Documents/Examen_POO/BatlleShip/assets/images/sous_marin.png"),
            "torpilleur": pygame.image.load("/media/nathan/liaison/Documents/Examen_POO/BatlleShip/assets/images/torpilleur.png")
        }
        ...
        for ligne in range(TAILLE_GRILLE):
            for colonne in range(TAILLE_GRILLE):
                if self.grille[ligne][colonne] == 1 and joueur1:
                    ...
                    screen.blit(navire_image, rect[:2])
...
def configurer_jeu():
    ...
    jeu.grille1.placer_bateau(2, 1, 5, 'H', "porte_avions", joueur1=True)
    ...
    jeu.grille1.placer_bateau(10, 1, 2, 'H', "torpilleur", joueur1=True)
