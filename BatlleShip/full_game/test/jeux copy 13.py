...
class Grille:
    def __init__(self, decalage_x, decalage_y):
        ...
        self.images_navires = {
            "contre_torpilleur": self.charger_image("BatlleShip/assets/images/contre_torpilleur.png", 3),
            "porte_avions": self.charger_image("BatlleShip/assets/images/porte_avions.png", 5),
            "sous_marin": self.charger_image("BatlleShip/assets/images/sous_marin.png", 3),
            "torpilleur": self.charger_image("BatlleShip/assets/images/torpilleur.png", 2),
            "croiseur": self.charger_image("BatlleShip/assets/images/croiseur.png", 4)
        }
        self.taille_navires = {
            "porte_avions": 5,
            "croiseur": 4,
        ...
        self.images_navires_dimensions = {}  # Dictionnaire pour stocker les dimensions initiales des images


    def charger_image(self, chemin, taille_navire):
        # Charger l'image et la redimensionner
        image = pygame.image.load(chemin)
        largeur = TAILLE_CELLULE * taille_navire + MARGE * (taille_navire - 1)
        hauteur = TAILLE_CELLULE
        image = pygame.transform.scale(image, (largeur, hauteur))

        # Stocker les dimensions initiales de l'image
        self.images_navires_dimensions[chemin] = (largeur, hauteur)
    ...
    def dessiner(self, screen):
        ...
        for navire in self.navires:
            ...
            if orientation == 'H':
                ...
                image_navire_vertical = pygame.transform.rotate(image_navire, 90)
                screen.blit(image_navire_vertical, ((MARGE + TAILLE_CELLULE) * colonne + MARGE + self.decalage_x,
                                                    (MARGE + TAILLE_CELLULE) * ligne + MARGE + self.decalage_y))
