...
class Grille:
    def __init__(self, decalage_x, decalage_y):
        ...
        self.porte_avions_image = pygame.image.load("assets/images/porte_avions.png")
        self.sous_marin_image = pygame.image.load("assets/images/sous_marin.png")
        self.torpilleur_image = pygame.image.load("assets/images/torpilleur.png")
        self.croiseur_image = pygame.image.load("assets/images/croiseur.png")
        self.contre_torpilleur_image = pygame.image.load("assets/images/contre_torpilleur.png")
